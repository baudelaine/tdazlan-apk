...
function SupprimerContact(){
    ...
    $.ajax({
        type: 'POST',
        url: "http://demo1.tdazlan.eu-de.mybluemix.net/SupprimerContact",
        dataType: 'json',
...
function RecupererContact() {
    ...
    $.ajax({
        type: 'POST',
        url: "http://demo1.tdazlan.eu-de.mybluemix.net/RecupererContact",
        dataType: 'json',
...
function EnvoyerContact(){
	...
	$.ajax({
        type: 'POST',
        url: "http://demo1.tdazlan.eu-de.mybluemix.net/EnvoyerContact",
        dataType: 'json',
...
function Reset() {
	...
	$.ajax({
        type: 'POST',
        url: "http://demo1.tdazlan.eu-de.mybluemix.net/Logout",
        dataType: 'json',
...
function UploadCSVFile(){
    ...
    $.ajax({
      url: "http://demo1.tdazlan.eu-de.mybluemix.net/UploadCSVFile",
      type: "POST",
      data: fd,
...
function GetEventMessage() {
    ...
    $.ajax({
        type: 'POST',
        url: "http://demo1.tdazlan.eu-de.mybluemix.net/GetEventMessage",
        dataType: 'json',
...
function GetSampleMessage() {
    ...
    $.ajax({
        type: 'POST',
        url: "http://demo1.tdazlan.eu-de.mybluemix.net/GetSampleMessage",
        dataType: 'json',
...
function GetEventContacts() {
    ...
    $.ajax({
        type: 'POST',
        url: "http://demo1.tdazlan.eu-de.mybluemix.net/GetEventContacts",
        dataType: 'json',
...
function SendSMS() {
    ...
    $.ajax({
        type: 'POST',
        url: "http://demo1.tdazlan.eu-de.mybluemix.net/SendSMS",
        dataType: 'json',
